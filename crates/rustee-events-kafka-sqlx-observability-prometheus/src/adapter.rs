...
fn append_backlog_metrics(output: &mut String, snapshot: &KafkaDelayedRetryRelayMetricsSnapshot) {
    append_line(
        output,
...
fn append_duration_metrics(output: &mut String, snapshot: &KafkaDelayedRetryRelayMetricsSnapshot) {
    append_line(
        output,
